    ...
    <div class="max-w-md w-full">
        <div class="bg-white rounded-2xl shadow-xl p-8 space-y-6">
            ...
            <form class="space-y-5" action="{{ route('login') }}" method="POST">
                ...
                @if(session('success'))
                    <div class="bg-green-50 border-l-4 border-green-400 text-green-700 px-4 py-3 rounded-r">
                ...
                @if($enableEmailAuth)
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <a href="{{ route('password.request') }}" class="font-medium text-blue-600 hover:text-blue-700 hover:underline transition duration-150" wire:navigate>
                                Forgot password?
                            </a>
                        </div>
                    </div>
                ...
                @else
                    <div class="bg-yellow-50 border-l-4 border-yellow-400 text-yellow-700 px-4 py-3 rounded-r">
                        <p class="text-sm">Email login is currently disabled.</p>
                    </div>
                @endif
